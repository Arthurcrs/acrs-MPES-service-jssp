...
# Primary y-axis: Menor Energia
ax1.plot(results_df['Chain Strength'], results_df['Menor energia'], marker='o', color='blue', label='Menor Energia')
ax1.set_xlabel('Força da cadeia', color='black', fontsize=14)  # X label text black and increased font size
ax1.set_ylabel('Menor Energia', color='black', fontsize=14)  # Y label text black and increased font size
ax1.tick_params(axis='y', labelcolor='blue')
ax1.grid(True)

# Secondary y-axis: Chain Breaks percentage
ax2 = ax1.twinx()
ax2.plot(results_df['Chain Strength'], results_df['Percentual médio de chainbreaks entre as amostras'], 
         marker='^', color='red', label='Média de quebra de cadeias (%)')  # Changed color to red
ax2.set_ylabel('Média de quebra de cadeias (%)', color='black', fontsize=14)  # Y label text black and increased font size
